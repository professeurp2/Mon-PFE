...
\begin{equation}
    \textbf{AN : } Steps/mm = \frac{N_{pas/tour} \times \mu{Step}}{P_h} = \frac{200 \times 16}{5} = \boxed{640 \text{ Impulsions/mm}}
\end{equation}

Pour le plateau Trunnion rotatif Axe B (Réduction harmonique ratio $1:50$) :
\begin{equation}
    \textbf{AN : } Steps/\text{Degré} = \frac{200 \times 16 \times 50}{360^\circ} = \boxed{444,444 \text{ Impulsions/Degré}}
\end{equation}
