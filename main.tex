...
\setlength{\headheight}{15pt}   % Évite le warning fancyhdr
...
\fancyhead[L]{\bfseries\color{macouleur}\nouppercase{\leftmark}} % Chapitre à gauche
\fancyhead[R]{\bfseries\color{macouleur}\nouppercase{\rightmark}} % Section à droite
...
\newpage
\include{chap1_introduction}            % Introduction et Contexte du Projet
\include{chap2_revue_litterature}       % État de l'art et Revue de Littérature
\include{chap3_conception_mec}          % Étude Mécanique et Dimensionnement
\include{chap4_realisation_mecatro}     % Architecture Électronique et Mécatronique
\include{chap5_developpement_logiciel}  % Développement Logiciel et Cinématique UML
\include{chap6_tests_conclusion}        % Tests, Validation et Analyse Économique

% ===================== BACKMATTER =====================
\include{99_backmatter}                 % Bibliographie et Annexe Code (Look-Ahead)

% ===================== ANNEXES ========================
\newpage
\appendix
\include{99_annexe_documentation}      % Annexes Techniques : Code, Datasheets, Données Brutes, Manuel
